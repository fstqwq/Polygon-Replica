...
class TestUIWorkspace(UIHelpersMixin, E2ETestBase):
    ...
    def test_problems_page_shows_only_participating_problems(self) -> None:
        ...
        self.assertIn('<section aria-label="Problem list">', html)
        self.assertIn('<th class="problem-list-head">Problem ID</th>', html)
...
""",
    ...
    def test_contests_root_page_is_top_level_without_selected_contest(self) -> None:
        ...
        self.assertIn('<section aria-label="Contest list">', html)
