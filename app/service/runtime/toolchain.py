...
class ToolchainService:
    ...
    def _unsupported_local_runtime(self, language: str) -> tuple[bool, str, str, str]:
        ...
        return (
            False,
            "",
            f"{token} local runtime execution has been removed; use domjudge-judgehost backend",
            digest,
        )
