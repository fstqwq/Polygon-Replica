...
RUN_DETAIL_TEST_LIST_LIMIT = 999
...
ADMIN_CONFIG_SPECS: dict[str, dict[str, object]] = {
    "WORKSPACE_FILE_LIST_LIMIT": {
        ...
        "min": 16,
        "max": 10000,
        "description": "Max files listed in file browser.",
    },
    "WORKSPACE_FILE_VIEW_CHAR_LIMIT": {
        "type": "int",
        "min": 1024,
        "max": 2097152,
        "description": "Max characters loaded in file editor preview.",
    },
    "TEXTAREA_MAX_BYTES": {
        "type": "int",
        "min": 1024,
        "max": 16777216,
        "description": "Shared UTF-8 byte limit for textarea form submissions.",
    },
    "UPLOAD_MAX_BYTES": {
        "type": "int",
        "min": 1024,
        "max": 1073741824,
        "description": "Shared raw-byte limit for uploaded files.",
    },
    "UI_LOG_TEXT_CHAR_LIMIT": {
        "type": "int",
        "min": 1024,
        "max": 2097152,
        "description": "Max log text rendered in UI.",
    },
    "RUN_DETAIL_TEST_LIST_LIMIT": {
        "type": "int",
        "min": 1,
        "max": 5000,
        "description": "Max tests shown in run details.",
    },
    "RUN_DETAIL_DIAGNOSTIC_LIST_LIMIT": {
        "type": "int",
        "min": 1,
        "max": 5000,
        "description": "Max diagnostics shown in run details.",
    },
    "RUN_TEST_FEEDBACK_FILE_LIST_LIMIT": {
        "type": "int",
        "min": 1,
        "max": 1024,
        "description": "Max feedback files listed per test.",
    },
    "RUN_DETAIL_PREVIEW_MAX_BYTES": {
        "type": "int",
        "min": 32,
        "max": 65536,
        "description": "Max preview bytes for artifact snippets.",
    },
    "RUN_TEST_SELECTOR_LIMIT": {
        "type": "int",
        "min": 1,
        "max": 10000,
        "description": "Max test options shown in run form.",
    },
    "PREVIEW_LOG_REF_LIST_LIMIT": {
        "type": "int",
        "min": 1,
        "max": 5000,
        "description": "Max statement log references parsed.",
    },
    "API_PROBLEMS_LIST_LIMIT": {
        "type": "int",
        "min": 1,
        "max": 10000,
        "description": "Max problems/contests returned per list API.",
    },
    "DIAGNOSTIC_MESSAGE_CHAR_LIMIT": {
        "type": "int",
        "min": 256,
        "max": 65536,
        "description": "Diagnostic message truncation limit.",
    },
    "UI_JSON_CHAR_LIMIT": {
        "type": "int",
        "min": 1024,
        "max": 16777216,
        "description": "json parse limit in UI.",
    },
    ...
    "SOLUTION_LIST_LIMIT": {
        ...
        "min": 1,
        "max": 5000,
        "description": "Max solution files listed.",
    },
    ...
    "FLASH_QUEUE_MAX_ITEMS": {
        ...
        "min": 1,
        "max": 256,
        "description": "Max queued flash messages.",
    },
    "FLASH_MESSAGE_MAX_LEN": {
        "type": "int",
        "min": 16,
        "max": 4096,
        "description": "Per-flash message max length.",
    },
    "PASSWORD_FORM_CSRF_TTL_SEC": {
        "type": "int",
        "min": 60,
        "max": 86400,
        "description": "Password form CSRF token lifetime in seconds.",
    },
    "PASSWORD_FORM_CSRF_SECRET": {
        "type": "str",
        "description": "Password form CSRF signing secret (empty means random-at-startup).",
    ...
    "LOGIN_RATE_LIMIT_WINDOW_SEC": {
        ...
        "min": 1.0,
        "max": 86400.0,
        "description": "Login rate-limit observation window in seconds.",
    },
    "LOGIN_RATE_LIMIT_BLOCK_SEC": {
        "type": "float",
        "min": 1.0,
        "max": 86400.0,
        "description": "Login rate-limit block duration in seconds.",
    },
    ...
    "GENERAL_TIME_LIMIT_MIN_MS": {
        ...
        "min": 1,
        "max": 60000,
        "description": "Lower bound for problem TL (ms).",
    },
    "GENERAL_TIME_LIMIT_MAX_MS": {
        "type": "int",
        "min": 1,
        "max": 300000,
        "description": "Upper bound for problem TL (ms).",
    },
    "GENERAL_MEMORY_LIMIT_MIN_MB": {
        "type": "int",
        "min": 1,
        "max": 65536,
        "description": "Lower bound for memory limit (MB).",
    },
    "GENERAL_MEMORY_LIMIT_MAX_MB": {
        "type": "int",
        "min": 1,
        "max": 262144,
        "description": "Upper bound for memory limit (MB).",
    },
    "GENERAL_PASS_LIMIT_MIN": {
        "type": "int",
        "min": 1,
        "max": 1024,
        "description": "Lower bound for pass limit.",
    },
    "GENERAL_PASS_LIMIT_MAX": {
        "type": "int",
        "min": 1,
        "max": 1024,
        "description": "Upper bound for pass limit.",
    },
    "TESTS_SPEC_ROWS_LIMIT": {
        "type": "int",
        "min": 1,
        "max": 10000,
        "description": "Max tests rows loaded from tests/spec.json.",
    },
    "TESTS_SPEC_PREVIEW_CHARS": {
        "type": "int",
        "min": 16,
        "max": 65536,
        "description": "Chars shown in tests/spec previews.",
    },
    "TESTS_SPEC_PREVIEW_LINES": {
        "type": "int",
        "min": 1,
        "max": 1024,
        "description": "Lines shown in tests/spec previews.",
    },
    "TESTS_SPEC_MANUAL_INLINE_EDIT_MAX_BYTES": {
        "type": "int",
        "min": 128,
        "max": 10485760,
        "description": "Max bytes for inline manual test edits.",
    },
    "TESTS_SPEC_MANUAL_PREVIEW_BYTES": {
        "type": "int",
        "min": 16,
        "max": 65536,
        "description": "Bytes shown for manual test payload preview.",
    },
    "TOOLCHAIN_CPP_COMPILER": {
        "type": "str",
        "description": (
            "C++ compiler executable for source compilation "
            "(for example: g++, clang++)."
        ),
    },
    "TOOLCHAIN_PYTHON_EXECUTABLE": {
        "type": "str",
        "description": "Python executable used for source compile-check.",
    },
    "TOOLCHAIN_JAVA_COMPILER": {
        "type": "str",
        "description": "Java compiler executable used for source compilation (for example: javac).",
    },
    "TOOLCHAIN_JUDGEHOST_CPP_COMPILE_FLAGS": {
        "type": "str",
        "description": "Judgehost C++ compile flags used in DOMjudge-compatible compile script.",
    },
    "TOOLCHAIN_JUDGEHOST_JAVA_COMPILE_FLAGS": {
        "type": "str",
        "description": "Judgehost Java compile flags used in DOMjudge-compatible compile script.",
    },
    "TOOLCHAIN_JUDGEHOST_PYTHON_COMPILE_FLAGS": {
        "type": "str",
        "description": (
            "Judgehost Python interpreter flags used before -m py_compile "
            "in compile script."
        ),
    },
    ...
    "TOOLCHAIN_COMPILE_MEMORY_MB": {
        ...
        "min": 64,
        "max": 262144,
        "description": "Compilation memory limit in MB.",
        "restart_required": False,
        "impact": "runtime",
    },
    ...
    "AUX_DISPLAY_TEXT_LIMIT_BYTES": {
        ...
        "max": 1048576,
        "description": (
            "Unified byte cap for front-end-facing auxiliary text such as compile, "
            "error, feedback, and diagnostic messages."
        ),
        "restart_required": False,
        "impact": "runtime",
    },
    ...
    "RUN_EXEC_PROCESS_LIMIT": {
        ...
        "min": 1,
        "max": 4096,
        "description": "Run-time sandbox process limit.",
        "restart_required": False,
        "impact": "runtime",
    },
    "RUN_EXEC_OUTPUT_KB": {
        ...
        "max": 1048576,
        "description": (
            "Judgehost run-stage stdout cap in KiB; compile/compare sandbox output "
            "uses TOOLCHAIN_COMPILE_OUTPUT_KB."
        ),
        "restart_required": False,
        "impact": "runtime",
    },
    "JUDGEHOST_STORED_LOG_LIMIT_BYTES": {
        ...
        "max": 16777216,
        "description": (
            "Max bytes of judgehost auxiliary compile output and compile metadata "
            "stored server-side before truncation."
        ),
        "restart_required": False,
        "impact": "runtime",
    },
    "RUN_WALL_TIME_SLACK_PASS_FAIL_SEC": {
        ...
        "max": 300,
        "description": (
            "Wall-time slack seconds for pass-fail runs "
    ...
    "RUN_WALL_TIME_SLACK_INTERACTIVE_SEC": {
        ...
        "max": 300,
        "description": (
            "Wall-time slack seconds for interactive runs "
            "(effective timeout = 2*TL + slack)."
        ),
        "restart_required": False,
        "impact": "runtime",
    ...
    "PREVIEW_TEX_TIMEOUT_SEC": {
        ...
        "min": 5,
        "max": 1800,
        "description": "TeX compile timeout in seconds.",
        "restart_required": False,
        "impact": "runtime",
    },
    "PREVIEW_TEX_MEMORY_MB": {
        ...
        "min": 16,
        "max": 262144,
        "description": "TeX compile memory limit in MB.",
        "restart_required": False,
        "impact": "runtime",
    },
    "PREVIEW_TEX_PROCESS_LIMIT": {
        ...
        "min": 1,
        "max": 4096,
        "description": "TeX compile process limit.",
        "restart_required": False,
        "impact": "runtime",
    },
    "PREVIEW_TEX_OUTPUT_KB": {
        ...
        "min": 64,
        "max": 1048576,
        "description": "TeX compile output cap in KB.",
        "restart_required": False,
        "impact": "runtime",
    },
    "WORKER_QUEUE_THREADS": {
        ...
        "min": 1,
        "max": 64,
        "description": "Worker queue thread count.",
        "restart_required": True,
        "impact": "restart",
    },
    "WORKER_QUEUE_HISTORY_LIMIT": {
        ...
        "min": 32,
        "max": 10000,
        "description": "In-memory worker queue history row cap.",
        "restart_required": True,
        "impact": "restart",
    },
    "WORKER_QUEUE_CAPACITY": {
        ...
        "min": 1,
        "max": 100000,
        "description": "Worker queue pending capacity.",
        "restart_required": True,
        "impact": "restart",
    },
    ...
    "DB_SQL_TRACE_ENABLED": {
        "type": "bool",
        "description": "Enable per-statement SQLite trace logging (heavy; for debugging only).",
        "restart_required": False,
        "impact": "runtime",
    },
    "JUDGEHOST_ENABLE": {
        "type": "bool",
        "description": "Enable DOMserver-like judgehost queue APIs for verification execution.",
    },
    "JUDGEHOST_API_TOKEN": {
        "type": "str",
        "ascii": "visible",
        "description": "Bearer token for judgehost API authentication.",
    },
    "JUDGEHOST_API_USERNAME": {
        "type": "str",
        "ascii": "visible",
        "description": "Basic-auth username for DOMjudge judgehost compatibility API.",
    },
    ...
    "JUDGEHOST_WAIT_TIMEOUT_SEC": {
        ...
        "min": 5,
        "max": 86400,
        "description": "Backend wait timeout for judgehost task completion (seconds).",
    },
    "JUDGEHOST_WAIT_POLL_SEC": {
        "type": "float",
        "min": 0.05,
        "max": 30.0,
        "description": "Backend poll interval while waiting judgehost completion (seconds).",
    },
    "JUDGEHOST_ONLINE_WINDOW_SEC": {
        ...
        "max": 86400,
        "description": (
            "Seconds a judgehost is considered online since last "
