...
from app.impl.workspace.access import normalize_repo_role, problem_owner_count, require_manage_access
...
def workspace_access_grant(problem: str, user: str, target_user: str=Form(...), role: str=Form('read')):
    ...
    try:
        ...
        existing_role = existing['role'] if existing is not None else ''
