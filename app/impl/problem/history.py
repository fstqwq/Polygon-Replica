...
def history_page(
    ...
    try:
        ...
        if selected_revision:
            ...
            selected_diff, selected_diff_truncated = runtime().git_service.diff_for_revision(
                workspace,
                selected_commit,
            )
    ...
    return template_response(
        ...
        "history.html",
        {
            ...
            "diff_char_limit": int(runtime().git_service.DIFF_MAX_CHARS),
        },
    )
    ...
    try:
        ...
        with spool_fileobj(
            ...
            with ArchiveView(
                ...
                def apply_snapshot():
                    return runtime().workspace_archive_service.merge_zip(
                        workspace,
                        rooted,
                    )

                applied = runtime().workspace_mutation_service.write_locked(
                    workspace,
                    apply_snapshot,
                )
        message = (
