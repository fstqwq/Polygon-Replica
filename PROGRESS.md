...
- Run artifact endpoints now enforce exact expected run roots (`artifacts/<problem>/<build>/logs/run-<run_id>` or `run_root/invalid-runs/<run_id>`) and reject DB-poisoned path overrides.
