...
- Artifact directory browse/zip and run-artifact browse/zip now enforce symlink-safe file enumeration (skip symlink entries and out-of-root resolved targets).
