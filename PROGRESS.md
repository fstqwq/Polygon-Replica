...
- Run feedback key-file discovery (`judgemessage.txt`, `teammessage.txt`, `nextpass.in`) now uses a single symlink-safe directory walk per test, avoiding repeated recursive scans in run result assembly.
