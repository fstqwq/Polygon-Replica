...
- Run artifact endpoints now enforce artifact-root allowlisting (problem-scoped artifacts tree or `run_root/invalid-runs`) and reject DB-poisoned out-of-root artifact paths.
