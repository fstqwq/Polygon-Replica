...
`VerifiedRevisionReader`: committed source, manifest, verified testcase
...
from the Git-source digest, and is not added to the verified manifest. In
contrast, `test-data/` is consumed by projections and therefore retains strict
