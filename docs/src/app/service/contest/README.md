...
Statement review produces blocking HTML or transient PDF previews from workspace or native package source. Package download applies one registered adapter to every available native package in roster order and returns an all-or-nothing temporary bundle.
