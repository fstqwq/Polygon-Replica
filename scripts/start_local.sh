...
export POLYGON_REPLICA_CONTEST_SOURCE_ROOT=${POLYGON_REPLICA_CONTEST_SOURCE_ROOT:-/var/lib/polygon-replica/contest-sources}
export POLYGON_REPLICA_BACKUP_ROOT=${POLYGON_REPLICA_BACKUP_ROOT:-/var/backups/polygon-replica}
