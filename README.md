...
- Run artifact endpoints now enforce allowed artifact-root prefixes (`artifacts/<problem>/...` or `run_root/invalid-runs/...`) and reject DB-poisoned out-of-root paths.
