...
- Preview reuse candidate selection now scans paged history (not a fixed tiny recent window), preventing stale/poisoned recent rows from starving valid cache hits.
