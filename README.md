...
- **Partial scoring is unsupported.** Polygon Replica is specialized for ICPC-style contests; OI-style scoring and other workflows that award partial credit are outside its scope.
